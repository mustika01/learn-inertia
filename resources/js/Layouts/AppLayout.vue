                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink v-if="permissions.post.view" :href="route('posts.index')"
                                    :active="route().current('posts.index')">
                                    Posts
                                </NavLink>
                                <NavLink v-if="permissions.role.view" :href="route('roles.index')"
                                    :active="route().current('roles.index')">
                                    Roles
                                </NavLink>
                                <NavLink v-if="permissions.employee.view" :href="route('employees.index')"
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <div class="ml-3 relative dark:bg-gr">
                                <!-- Teams Dropdown -->
